    ...
    <div className="flex flex-col items-center w-full">
      ...
      <section className="relative w-full min-h-[85vh] flex flex-col justify-center items-center overflow-hidden">
        ...
        <div className="absolute bottom-10 left-1/2 transform -translate-x-1/2 flex flex-col items-center animate-fade-in delay-500">
          <span className="text-[var(--color-ronalix-muted)] text-xs mb-2">{t.home_scroll}</span>
      ...
      <section className="w-full py-24 bg-[var(--background)] border-t border-[var(--color-ronalix-gray)]/30 relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="text-3xl font-bold mb-4 text-white">{t.home_philosophy}</h2>
            <p className="text-[var(--color-ronalix-muted)] text-lg">{t.home_philosophy_desc}</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-[var(--color-ronalix-gray)]/40 border border-white/5 rounded-xl p-8 hover:border-[var(--color-ronalix-neon)]/30 transition-colors">
              ...
              <h3 className="text-xl font-semibold mb-3 text-white">{t.home_efficiency}</h3>
              <p className="text-[var(--color-ronalix-muted)] text-sm">{t.home_efficiency_desc}</p>
            </div>
            ...
            <div className="bg-[var(--color-ronalix-gray)]/40 border border-white/5 rounded-xl p-8 hover:border-[var(--color-ronalix-neon)]/30 transition-colors">
              ...
              <h3 className="text-xl font-semibold mb-3 text-white">{t.home_local}</h3>
              <p className="text-[var(--color-ronalix-muted)] text-sm">{t.home_local_desc}</p>
            </div>
            ...
            <div className="bg-[var(--color-ronalix-gray)]/40 border border-white/5 rounded-xl p-8 hover:border-[var(--color-ronalix-neon)]/30 transition-colors">
              ...
              <h3 className="text-xl font-semibold mb-3 text-white">{t.home_reasoning}</h3>
              <p className="text-[var(--color-ronalix-muted)] text-sm">{t.home_reasoning_desc}</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="w-full py-20 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-6 text-white">{t.home_ready}</h2>
          <p className="text-[var(--color-ronalix-muted)] mb-8 text-lg">{t.home_ready_desc}</p>

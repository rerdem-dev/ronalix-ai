export default function DocsPage() {
  const docSections = [
    { title: "Models", desc: "Overview of Ronalix models and their specific use-cases." },
    { title: "Installation", desc: "How to download and set up our models locally." },
    { title: "Local Inference", desc: "Running models via Ollama, vLLM, or LM Studio." },
    { title: "Fine-tuning", desc: "Guides for adapting Ronalix models to your data." },
    { title: "API (Coming Soon)", desc: "Documentation for the upcoming Ronalix Cloud API." },
    { title: "Agent Integration", desc: "Using our reasoning models within agentic frameworks." }
  ];
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 flex flex-col md:flex-row gap-12">
      ...
      <aside className="w-full md:w-64 flex-shrink-0 animate-fade-in">
        <div className="sticky top-28">
          <h3 className="text-sm font-semibold text-[var(--color-ronalix-muted)] uppercase tracking-wider mb-4">Documentation</h3>
      ...
      <main className="flex-1 animate-slide-up delay-100">
        <div className="prose prose-invert prose-neon max-w-none">
          <h1 className="text-4xl font-bold text-white mb-2">Ronalix Documentation</h1>
          <p className="text-xl text-[var(--color-ronalix-muted)] mb-10">
            Welcome to the official documentation for Ronalix AI models and tools.
          </p>
          ...
          <div className="bg-[var(--color-ronalix-gray)]/30 border border-white/5 rounded-xl p-6 mb-10">
            ...
            <p className="text-gray-300 text-sm leading-relaxed">
              Our models are currently in active development. This documentation outlines the planned usage patterns and architecture. Full technical guides, API references, and inference code will be published alongside our first official model releases.
            </p>
          </div>
          ...
          <div className="mt-16 border-t border-white/10 pt-8">
            ...
            <p className="text-gray-300 text-sm leading-relaxed mb-4">
              We believe in open-source collaboration. Once our repositories are public, we welcome contributions to our evaluation scripts, inference wrappers, and documentation.
            </p>
